...
export default function ResetPINOTPScreen({ route, navigation }) {
    ...
    return (
        ...
        >
            ...
            <View style={styles.body}>
                ...
                <TouchableOpacity onPress={handleResend} disabled={secondsLeft > 0 || resending} style={styles.resendWrap} activeOpacity={0.7}>
                    {resending
